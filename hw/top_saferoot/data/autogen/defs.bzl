...
load("//hw/top_saferoot/ip_autogen/alert_handler:defs.bzl", "ALERT_HANDLER")
load("//hw/ip/aon_timer:defs.bzl", "AON_TIMER")
load("//hw/top_saferoot/ip_autogen/clkmgr:defs.bzl", "CLKMGR")
load("//hw/ip/csrng:defs.bzl", "CSRNG")
load("//hw/ip/edn:defs.bzl", "EDN")
load("//hw/ip/entropy_src:defs.bzl", "ENTROPY_SRC")
load("//hw/top_saferoot/ip_autogen/flash_ctrl:defs.bzl", "FLASH_CTRL")
load("//hw/top_saferoot/ip_autogen/gpio:defs.bzl", "GPIO")
...
load("//hw/top_saferoot/ip_autogen/otp_ctrl:defs.bzl", "OTP_CTRL")
load("//hw/ip/otp_macro:defs.bzl", "OTP_MACRO")
load("//hw/top_saferoot/ip_autogen/pinmux:defs.bzl", "PINMUX")
load("//hw/top_saferoot/ip_autogen/pwrmgr:defs.bzl", "PWRMGR")
load("//hw/ip/rom_ctrl:defs.bzl", "ROM_CTRL")
load("//hw/top_saferoot/ip_autogen/rstmgr:defs.bzl", "RSTMGR")
load("//hw/top_saferoot/ip_autogen/rv_core_ibex:defs.bzl", "RV_CORE_IBEX")
load("//hw/top_saferoot/ip_autogen/rv_plic:defs.bzl", "RV_PLIC")
load("//hw/ip/rv_timer:defs.bzl", "RV_TIMER")
load("//hw/top_saferoot/ip/sensor_ctrl:defs.bzl", "SENSOR_CTRL")
