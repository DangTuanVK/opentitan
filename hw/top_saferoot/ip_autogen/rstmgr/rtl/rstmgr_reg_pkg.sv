...
package rstmgr_reg_pkg;
  ...
  parameter int NumTotalResets = 6;
  ...
  typedef struct packed {
    ...
    rstmgr_reg2hw_reset_info_reg_t reset_info; // [18:15]
    rstmgr_reg2hw_alert_info_ctrl_reg_t alert_info_ctrl; // [14:10]
    rstmgr_reg2hw_cpu_info_ctrl_reg_t cpu_info_ctrl; // [9:5]
    rstmgr_reg2hw_sw_rst_ctrl_n_mreg_t [1:0] sw_rst_ctrl_n; // [4:3]
    rstmgr_reg2hw_err_code_reg_t err_code; // [2:0]
  } rstmgr_reg2hw_t;

  // HW -> register type
  typedef struct packed {
    rstmgr_hw2reg_reset_req_reg_t reset_req; // [94:90]
    rstmgr_hw2reg_reset_info_reg_t reset_info; // [89:82]
  ...
  parameter logic [BlockAw-1:0] RSTMGR_SW_RST_REGWEN_0_OFFSET = 6'h 2c;
  parameter logic [BlockAw-1:0] RSTMGR_SW_RST_REGWEN_1_OFFSET = 6'h 30;
  parameter logic [BlockAw-1:0] RSTMGR_SW_RST_CTRL_N_0_OFFSET = 6'h 34;
  parameter logic [BlockAw-1:0] RSTMGR_SW_RST_CTRL_N_1_OFFSET = 6'h 38;
  parameter logic [BlockAw-1:0] RSTMGR_ERR_CODE_OFFSET = 6'h 3c;
  ...
  parameter logic [3:0] RSTMGR_PERMIT [16] = '{
    ...
    4'b 0001, // index[13] RSTMGR_SW_RST_CTRL_N_0
    4'b 0001, // index[14] RSTMGR_SW_RST_CTRL_N_1
    4'b 0001  // index[15] RSTMGR_ERR_CODE
  };
