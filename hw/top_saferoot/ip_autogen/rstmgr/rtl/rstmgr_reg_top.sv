...
module rstmgr_reg_top (
  ...
  always_comb begin
    ...
    addr_hit[13] = (reg_addr == RSTMGR_SW_RST_CTRL_N_0_OFFSET);
    addr_hit[14] = (reg_addr == RSTMGR_SW_RST_CTRL_N_1_OFFSET);
    addr_hit[15] = (reg_addr == RSTMGR_ERR_CODE_OFFSET);
  end
  ...
  assign sw_rst_ctrl_n_0_we = addr_hit[13] & reg_we & !reg_error;

  assign sw_rst_ctrl_n_0_wd = reg_wdata[0];
  assign sw_rst_ctrl_n_1_we = addr_hit[14] & reg_we & !reg_error;
  ...
  always_comb begin
    ...
    reg_we_check[13] = sw_rst_ctrl_n_0_gated_we;
    reg_we_check[14] = sw_rst_ctrl_n_1_gated_we;
