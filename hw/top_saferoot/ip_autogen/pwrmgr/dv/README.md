...
* [Simulation results](https://reports.opentitan.org/hw/top_saferoot/ip_autogen/pwrmgr/dv/latest/report.html)
...
### Top level testbench
Top level testbench is located at [`hw/top_saferoot/ip_autogen/pwrmgr/dv/tb.sv`](https://github.com/lowRISC/opentitan/blob/master/hw/top_saferoot/ip_autogen/pwrmgr/dv/tb.sv).
It instantiates the PWRMGR DUT module [`hw/top_saferoot/ip_autogen/pwrmgr/rtl/pwrmgr.sv`](https://github.com/lowRISC/opentitan/blob/master/hw/top_saferoot/ip_autogen/pwrmgr/rtl/pwrmgr.sv).
In addition, it instantiates the following interfaces, connects them to the DUT and sets their handle into `uvm_config_db`:
* [Clock and reset interface](../../../../dv/sv/common_ifs/README.md)
* [TileLink host interface](../../../../dv/sv/tl_agent/README.md)
* PWRMGR interface [`hw/top_saferoot/ip_autogen/pwrmgr/dv/env/pwrmgr_if.sv`](https://github.com/lowRISC/opentitan/blob/master/hw/top_saferoot/ip_autogen/pwrmgr/dv/env/pwrmgr_if.sv).
...
[`pwrmgr_env_pkg`](https://github.com/lowRISC/opentitan/blob/master/hw/top_saferoot/ip_autogen/pwrmgr/dv/env/pwrmgr_env_pkg.sv).
...
All test sequences reside in [`hw/top_saferoot/ip_autogen/pwrmgr/dv/env/seq_lib`](https://github.com/lowRISC/opentitan/blob/master/hw/top_saferoot/ip_autogen/pwrmgr/dv/env/seq_lib), and extend `pwrmgr_base_vseq`.
...
- Outputs `core_clk_en`, `io_clk_en`, and `usb_clk_en` reset low, and go high prior to the slow fsm requesting the fast fsm to wakeup.
  ...
  These clock enables are checked via SVAs in [`hw/top_saferoot/ip_autogen/pwrmgr/dv/sva/pwrmgr_clock_enables_sva_if.sv`](https://github.com/lowRISC/opentitan/blob/master/hw/top_saferoot/ip_autogen/pwrmgr/dv/sva/pwrmgr_clock_enables_sva_if.sv).
...
- Inputs `core_clk_val`, `io_clk_val`, and `usb_clk_val` track the corresponding enables.
  ...
  These inputs are checked via SVAs in [`hw/top_saferoot/ip_autogen/pwrmgr/dv/sva/pwrmgr_ast_sva_if.sv`](https://github.com/lowRISC/opentitan/blob/master/hw/top_saferoot/ip_autogen/pwrmgr/dv/sva/pwrmgr_ast_sva_if.sv).
...
#### Assertions
The [`hw/top_saferoot/ip_autogen/pwrmgr/dv/sva/pwrmgr_bind.sv`](https://github.com/lowRISC/opentitan/blob/master/hw/top_saferoot/ip_autogen/pwrmgr/dv/sva/pwrmgr_bind.sv) module binds a few modules containing assertions to the IP as follows:
...
```console
$ $REPO_TOP/util/dvsim/dvsim.py $REPO_TOP/hw/top_saferoot/ip_autogen/pwrmgr/dv/pwrmgr_sim_cfg.hjson -i pwrmgr_smoke
```
