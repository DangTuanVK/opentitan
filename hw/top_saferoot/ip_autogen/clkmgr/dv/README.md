...
* [Simulation results](https://reports.opentitan.org/hw/top_saferoot/ip_autogen/clkmgr/dv/latest/report.html)
...
### Top level testbench
Top level testbench is located at `hw/top_saferoot/ip_autogen/clkmgr/dv/tb.sv`.
It instantiates the CLKMGR DUT module `hw/top_saferoot/ip_autogen/clkmgr/rtl/clkmgr.sv`.
In addition, it instantiates the following interfaces, connects them to the DUT and sets their handle into `uvm_config_db`:

* [Clock and reset interface](../../../../dv/sv/common_ifs/README.md)
* [TileLink host interface](../../../../dv/sv/tl_agent/README.md)
* CLKMGR IOs: `hw/top_saferoot/ip_autogen/clkmgr/dv/env/clkmgr_if.sv`
...
### Test sequences
All test sequences reside in `hw/top_saferoot/ip_autogen/clkmgr/dv/env/seq_lib`.
...
See more detailed description at `hw/top_saferoot/ip_autogen/clkmgr/data/clkmgr_testplan.hjson`.
...
```console
$ $REPO_TOP/util/dvsim/dvsim.py $REPO_TOP/hw/top_saferoot/ip_autogen/clkmgr/dv/clkmgr_sim_cfg.hjson -i clkmgr_smoke
```
