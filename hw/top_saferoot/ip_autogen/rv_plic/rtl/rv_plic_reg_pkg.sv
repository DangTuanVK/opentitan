...
package rv_plic_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    rv_plic_reg2hw_prio_mreg_t [100:0] prio; // [316:115]
    rv_plic_reg2hw_ie0_mreg_t [100:0] ie0; // [114:14]
  ...
  // HW -> register type
  typedef struct packed {
    rv_plic_hw2reg_ip_mreg_t [100:0] ip; // [208:7]
  ...
  parameter logic [3:0] RV_PLIC_PERMIT [113] = '{
    ...
    4'b 1111, // index[101] RV_PLIC_IP_0
    4'b 1111, // index[102] RV_PLIC_IP_1
    4'b 1111, // index[103] RV_PLIC_IP_2
    4'b 0001, // index[104] RV_PLIC_IP_3
    4'b 1111, // index[105] RV_PLIC_IE0_0
    4'b 1111, // index[106] RV_PLIC_IE0_1
    4'b 1111, // index[107] RV_PLIC_IE0_2
    4'b 0001, // index[108] RV_PLIC_IE0_3
    4'b 0001, // index[109] RV_PLIC_THRESHOLD0
    4'b 0001, // index[110] RV_PLIC_CC0
    4'b 0001, // index[111] RV_PLIC_MSIP0
    4'b 0001  // index[112] RV_PLIC_ALERT_TEST
  };
