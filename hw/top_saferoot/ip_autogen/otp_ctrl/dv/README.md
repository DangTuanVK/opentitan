...
* [Simulation results](https://reports.opentitan.org/hw/top_saferoot/ip_autogen/otp_ctrl/dv/latest/report.html)
...
### Top level testbench
Top level testbench is located at `hw/top_saferoot/ip_autogen/otp_ctrl/dv/tb.sv`. It instantiates the OTP_CTRL DUT module `hw/top_saferoot/ip_autogen/otp_ctrl/rtl/otp_ctrl.sv`.
...
### Stimulus strategy
#### Test sequences
All test sequences reside in `hw/top_saferoot/ip_autogen/otp_ctrl/dv/env/seq_lib`.
...
```console
$ $REPO_TOP/util/dvsim/dvsim.py $REPO_TOP/hw/top_saferoot/ip_autogen/otp_ctrl/dv/otp_ctrl_sim_cfg.hjson -i otp_ctrl_smoke
```
