...
package otp_scrambler_pkg;
  ...
  parameter key_array_t RndCnstKey = {
    top_saferoot_rnd_cnst_pkg::RndCnstOtpCtrlScrmblKey2,
    top_saferoot_rnd_cnst_pkg::RndCnstOtpCtrlScrmblKey1,
    top_saferoot_rnd_cnst_pkg::RndCnstOtpCtrlScrmblKey0
  };

  parameter digest_const_array_t RndCnstDigestConst = {
    top_saferoot_rnd_cnst_pkg::RndCnstOtpCtrlDigestConst3,
    top_saferoot_rnd_cnst_pkg::RndCnstOtpCtrlDigestConst2,
    top_saferoot_rnd_cnst_pkg::RndCnstOtpCtrlDigestConst1,
    top_saferoot_rnd_cnst_pkg::RndCnstOtpCtrlDigestConst0
  };

  parameter digest_iv_array_t RndCnstDigestIV = {
    top_saferoot_rnd_cnst_pkg::RndCnstOtpCtrlDigestIV3,
    top_saferoot_rnd_cnst_pkg::RndCnstOtpCtrlDigestIV2,
    top_saferoot_rnd_cnst_pkg::RndCnstOtpCtrlDigestIV1,
    top_saferoot_rnd_cnst_pkg::RndCnstOtpCtrlDigestIV0
  };
